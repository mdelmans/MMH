...
#define ERR_STOP_COMMAND_ISSUED 110
#define ERR_REACHED_STAGE_LIMIT 111

#define XYSTAGE_FORWARD true
#define XYSTAGE_BACKWARD false
...
class CArduinoXYStage : public CXYStageBase < CArduinoXYStage >
{
public:
	CArduinoXYStage();
	~CArduinoXYStage();
	...
	double GetStepSizeXUm(){ return this->stepSizeX_; };
	double GetStepSizeYUm(){ return this->stepSizeY_; };
	...
	int SetStepSizeX(MM::PropertyBase* pProp, MM::ActionType eAct);
	int SetStepSizeY(MM::PropertyBase* pProp, MM::ActionType eAct);
	int SetMaxX(MM::PropertyBase* pProp, MM::ActionType eAct);
	int SetMaxY(MM::PropertyBase* pProp, MM::ActionType eAct);
...
private:
	...
	int StepX(bool forward);
	int StepY(bool forward);
